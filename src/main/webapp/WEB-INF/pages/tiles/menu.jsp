		...
		<div class="list-menu-wrapper" style="float: right;">
			<ul style="list-style-image: url(images/img.jpg); text-align: left;">
				...
				<c:if test="${sessionScope.role eq 'admin'}">
					...
					<a href="controller?command=do_add_news">add news</a>
	...
	<div class="list-menu-invisible-wrapper">
		<div class="list-menu-wrapper" style="float: right;">
			<ul style="list-style-image: url(images/img.jpg); text-align: left;">
				...
				<a href="controller?command=go_to_news_list">Список новостей</a><br/>
				</li>
			
				<c:if test="${sessionScope.role eq 'admin'}">
					<li style="padding-left: 5px;">
					
					<a href="controller?command=do_add_news">Добавить новость</a>
